...
Note:
   Any comments with "#*" in front of them are for example/infrastructure 
   clarifications only.
...
#*
#* Note:
#*   ats.log.utils provides some logging utilities, such as banners & etc
#*
#* Example:
...
#*
#* Read More:
#*   Python Logging HOWTO - https://docs.python.org/3.4/howto/logging.html
#*******************************************************************************
...
class CommonSetup(aetest.CommonSetup):
    ...
    Subsections:
        ...
        self_is_self: in each section, self is always self.
    ...
    Results:
        - the overall result of Common Setup section is calculated as the roll
          ...
          documented with ats.results module.
    ...
    #*  values will be provided as inputs.
    @aetest.subsection
    ...
    #******************************
    #* Class Instance Consistency
    #*
    #*  self within the same class is always preserved and reused for each 
    #*  section within that class. Eg - During execution, all subsection methods 
    #*  are passed the same CommonSetup object instance, and thus passing 
    #*  values around subsection can be done easily using self.<attribute>. 
    #*  
    #*  This is an important property of AEtest class design, allowing sections
    #*  to easily pass values around.
    #*
    #*  WARNING:
    #*     This is significantly different from Python unittest or pytest, where
    #*     each method is instantiated and encapsulated in its own test class.
    @aetest.subsection
    ...
    #*  were actually defined multiple times.)
...
class ExampleTestcase(aetest.Testcase):
    ...
    Results:
        - the overall result of Testcase section is calculated as the roll
          ...
          up behavior is well documented with ats.results module.
    ...
    #*
    #*   Note:
    #*      it's easier to use to default to using the docstring for testcase
    #*      description
...
#*
#*      bash$ python pyats-sample-scripts/base_example.py
#*
